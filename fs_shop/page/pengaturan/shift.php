      ...
      <div id="content-wrapper">
        <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #2ecc71">
          <div class="navbar-nav">
            <a class="nav-item nav-link active" href="#">Data Shift<span class="sr-only">(current)</span> </a>
            <a class="nav-item nav-link " href="#">Ganti Shift  </a>
          </div>
        </nav>
      <!-- Main Dashboard -->
      <!--
          ...
          <div class="container form-spacing">
            ...
            <form method="post">
              <div class="form-element">
                <label for="ganti_shift">Buka / Tutup Shift</label>
              </div>
            </form>
          </div>
      </div>
