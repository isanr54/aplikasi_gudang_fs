            ...
            ?>
              <div class="col-sm-12">
                <fieldset>
                  ...
                  <form action="proses_level.php?id=<?=$update['id_user']?>" method="post">
                    <div class="row form-spacing">
                      <div class="col-sm-3">
                    ...
                    <div class="row form-spacing">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="nama_user" id="nama_user" class="form-control" value="<?=$update['nama_user']?>" disabled>
                      </div>
                    </div>
                    <div class="row form-spacing">
                      <div class="col-sm-3">
...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $query="UPDATE user SET level='".$level."' WHERE id_user='".$id_user."'";
