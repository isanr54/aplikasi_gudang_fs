      ...
      <div id="content-wrapper">
          <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #2ecc71">
            <div class="navbar-nav">
              <a class="nav-item nav-link active" href="#">Group User <span class="sr-only">(current)</span></a>
              <a class="nav-item nav-link" href="user_data.php">User Data</a>
            </div>
          </nav>
      <!-- Main Dashboard -->
      <!--
                ...
                <table class="table form-spacing table-hover">
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?=$lihat['level']?></td>
                        <td>
                          <a href="user_data/update_level.php?id=<?=$lihat["id_user"]?>" class="btn btn-warning">Edit</a>
